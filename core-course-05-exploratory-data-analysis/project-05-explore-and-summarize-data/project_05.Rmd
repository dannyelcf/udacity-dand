...
Log action is an activity taken to make progress in solving the issue. There are 
many possible log action to an issue. For the project analised, I found 14 
action types. See the frequency of them in the plot below.  
