...
Log status is the status of an issue after an activity (see 
[Log Action](#log-action)) to be performed. There are many possible status to 
an issue. The plot below shows the top 15 log status used in the project.
