...
of a issue. I grouped them in 4 types (see how in 
[issues_cleaning.R](data_wrangling/issues_cleaning.R)):

```{r "Issue Type Values"}
levels(issues$issue_type)
```

The frequency of issues created by each issue type is shown in the plot below.
