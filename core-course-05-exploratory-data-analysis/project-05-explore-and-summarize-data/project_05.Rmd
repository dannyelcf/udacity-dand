...
The issue deadline size represents the total planned time to solve an issue, 
that is, the difference between issue start and deadline date. This variable is 
interesting because it gives us an idea of the planning of the activities.
  ...
  plot_issue_deadline_size <-
    df_issue_deadline_size %>% 
      ggplot(aes(x = issue_deadline_size)) +
        ...
        labs(title = "Distribution of the Planned Time to Solve an Issue",
...
```{r "Distribution of the Planned Time to Solve an Issue"}
