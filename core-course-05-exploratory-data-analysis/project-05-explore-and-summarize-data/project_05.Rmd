...
The next 6 sections show the analisys of the temporal variables: four originally 
in the data set (`issue_creation_date`, `issue_start_date`, `issue_deadline_date` 
and `issue_time_spent`) and two derived from the calculation (`issue_delay_start` 
and `issue_deadline_size`). In an issue tracking system, temporal variables is 
