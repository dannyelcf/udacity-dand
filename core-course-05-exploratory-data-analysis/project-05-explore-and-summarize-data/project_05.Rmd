...
the red shading represents the 95% of mean confidence interval (not visible in 
...
data and solid grey vertical lines represent the 1st day of year.
...
cumulated median and mean, the red shading represents the 95% of cumulated mean 
confidence interval and solid grey vertical lines represent the 1st day of year.
...
cumulated median. The 95% of cumulated mean confidence interval also increases 
  ...
  plot_score_issue_created_by_wday <- 
    df_score_issue_created_by_wday %>% 
      ggplot(aes(x = issue_creation_wday, y = score)) +
        ...
        plot_frequency_ci(df_issue_created_by_wday, issue_creation_wday) +
...
> **Note:** In the plot above, the black dashed lines represent the 1st and 3rd 
quartile, the black and red solid lines represent, respectivaly, median and mean
and the red shading represents the 95% of mean confidence interval.
...
down, increase the standard deviation and the 95% of mean confidence interval. 
...
the 95% of mean confidence interval descrease. These new summaries better 
...
> **Note:** In the plot above, the black dashed lines represent the 1st and 3rd 
quartile, the black and red solid lines represent, respectivaly, median and mean,
the red shading represents the 95% of mean confidence interval and the black 
  ...
  plot_score_issue_deadline_wday <- 
    df_score_issue_deadline_wday %>% 
      ggplot(aes(x = issue_deadline_wday, y = score)) +
        geom_col(color = "grey50", alpha = .1) +
        plot_frequency_ci(df_issue_deadline_wday, issue_deadline_wday) +
...
> **Note:** In the plot above, the black dashed lines represent the 1st and 3rd 
quartile, the black and red solid lines represent, respectivaly, median and mean,
and red shading represents the 95% of mean confidence interval.
  ...
  plot_score_issue_type <- 
    df_score_issue_type %>% 
      ggplot(aes(x = reorder(issue_type, -score), y = score)) +
        geom_col(color = "grey50", alpha = .1) +
        plot_frequency_ci(df_issue_type, issue_type) +
...
plot_score_issue_system <- 
  df_score_issue_system %>% 
    ggplot(aes(x = reorder(issue_system, -score), y = score)) +
      geom_col(color = "grey50", alpha = .1) +
      plot_frequency_ci(df_issue_system, issue_system) +
...
plot_score_top15_issue_subsystem <- 
  df_score_top15_issue_subsystem %>% 
    ggplot(aes(x = reorder(issue_subsystem, -score), y = score)) +
      geom_col(color = "grey50", alpha = .1) +
      plot_frequency_ci(df_issue_subsystem, issue_subsystem, df_score_top15_issue_subsystem) +
...
plot_score_issue_stakeholder <- 
  df_score_issue_stakeholder %>% 
    ggplot(aes(x = reorder(issue_stakeholder, -score), y = score)) +
      geom_col(color = "grey50", alpha = .1) +
      plot_frequency_ci(df_issue_stakeholder, issue_stakeholder) +
      # scale_y_continuous(limits = c(0, .85), breaks = seq(0, 1, .1), 
      #                    labels = scales::percent) + 
...
plot_score_top15_issue_created_by <- 
  df_score_top15_issue_created_by %>% 
    ggplot(aes(x = reorder(issue_created_by, -score), y = score)) +
      geom_col(color = "grey50", alpha = .1) +
      plot_frequency_ci(df_issue_created_by, issue_created_by, df_score_top15_issue_created_by) +
